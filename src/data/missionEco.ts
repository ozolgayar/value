...
/** Strategy house spread: floors 4–3 (left) + floors 2–1 (right) over img/07.png */
export const missionStrategyHouse = {
  badge: 'СТРАТЕГИЯ ГЕРОФАРМ',
  background: 'img/07.png',
  left: {
    title: 'Стратегия ГЕРОФАРМ 2030\nпредставлена как дом.',
    intro: [
      ...
      'На вершине: стратегия встречается с миссией.',
    ],
    sections: [
      {
    ...
    ] satisfies StrategyHouseSection[],
    footnotes: [
      '*EBITDA — показатель финансовой результативности компании: прибыль до вычета расходов по процентам, уплаты налогов и амортизации основных средств и нематериальных активов',
